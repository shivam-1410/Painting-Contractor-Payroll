...
const AddLabourModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/40 backdrop-blur-md flex items-start justify-center z-50 p-4 pt-[10vh] md:pt-[12vh] overflow-y-auto animate-fade-in">
      <div className="bg-white/85 dark:bg-slate-900/85 backdrop-blur-lg border border-white/20 dark:border-slate-800/80 rounded-3xl w-full max-w-xl shadow-2xl overflow-hidden animate-scale-in my-auto md:my-0">
        {/* Header */}
